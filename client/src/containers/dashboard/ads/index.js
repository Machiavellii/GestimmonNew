...
class Ads extends Component {
  ...
  saveAdsInfo = (index, changedValue) => {
    this.state.adsArray[index] = changedValue;
  ...
  deleteAdsInfo = index => {
    this.state.adsArray.splice(index, 1)
    this.setState(
  ...
  addAdsInfo = newValue => {
    this.state.adsArray.push(newValue);
    this.setState({ adsArray: this.state.adsArray }, function() {
      this.uploadAdsInfo(this.state.adsArray);
    });
  };
