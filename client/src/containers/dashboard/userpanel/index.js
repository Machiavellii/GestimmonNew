...
import { countryList } from "../../../constants/data.json.js";
    ...
    return (
      <div className={classes.content}>
        ...
        <Grid
          ...
          spacing={10}
        >
          <Grid item style={{ minWidth: 240, maxWidth: 480 }} >
            <h1>{t[this.props.lang].profil}</h1>
            <FormControl required className={classes.formControl}>
              <InputLabel htmlFor="">{t[this.props.lang].civility}</InputLabel>
              <Select value={gender} onChange={this.handleTextInput("gender")}>
            ...
            <FormGroup>
              ...
              <br />
              <h1>{t[this.props.lang].address}</h1>
              <TextField
                id="address"
              ...
              <TextField
                id="zipcode"
                label={t[this.props.lang].zipcode}
                placeholder={t[this.props.lang].enter_your_zipcode}
                className={classes.textField}
                margin="normal"
                value={postCode}
              ...
              <FormControl className={classes.formControl}>
                ...
                >
                  {countryList.map((item, index) => {
                    return (
                      <MenuItem key={index} value={item.name[this.props.lang]}>
            ...
            <Card className={classes.card}>
              ...
              <CardContent>
                ...
                >
                  ...
                  <DialogActions>
                    <Button onClick={this.handlePasswordChange} color="primary">
